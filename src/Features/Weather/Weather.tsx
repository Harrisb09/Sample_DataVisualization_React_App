...
import { query } from './WeatherQuery';
import { graphQLUrl } from '../../shared/ApiEndpoint';
import { defaultLatitude, defaultLongitude } from '../../shared/Constants';
...
const Weather = () => {
  ...
  const latLong = {
    latitude: getLocation.latitude || defaultLatitude,
    longitude: getLocation.longitude || defaultLongitude,
  };
